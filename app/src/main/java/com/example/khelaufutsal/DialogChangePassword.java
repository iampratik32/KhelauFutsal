...
import com.example.khelaufutsal.Player.Player_SettingsActivity;
            ...
            public void onClick(View v) {
                ...
                if(passwordText.isEmpty() || passwordText.length()<7){
                    ...
                    if(FutsalHolder.getFutsal()!=null){
                        credential = FutsalHolder.getFutsal().getCredential();
                    }
                    else {
                        credential = PlayerHolder.getPlayer().getCredential();
                    }
                                ...
                                user.updatePassword(passwordText).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()){
                                                ...
                                                public void onComplete(@NonNull Task<AuthResult> task) {
                                                    if(task.isSuccessful()){
                                                        if(FutsalHolder.getFutsal()!=null){
                                                            ...
                                                            Intent settingsIntent = new Intent(getContext(), Futsal_SettingsActivity.class);
                                                            settingsIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                            startActivity(settingsIntent);
                                                        }
                                                        else {
                                                            PlayerHolder.getPlayer().setCredential(null);
                                                            Intent settingsIntent = new Intent(getContext(), Player_SettingsActivity.class);
                                                            settingsIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                                            startActivity(settingsIntent);
                                                        }
                                                        dismiss();
                                            ...
                                            Toast.makeText(getContext(),"Can't Change The Password At This Moment. ,",Toast.LENGTH_LONG).show();
